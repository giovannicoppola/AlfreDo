...
<a href="https://alfred.app/workflows/giovannicoppola/alfredo/">
<img alt="Gallery Downloads"
src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgiovannicoppola%2Falfred-gallery-downloads%2Fmain%2Fdownloads.json&query=%24.alfredo%5B0%5D.display&label=Gallery%20Downloads&color=blue&logo=alfred"><br/>
</a>
...
- Use:
    ...
    - `for ...` to set a task duration in natural language (e.g. `for 30 minutes`, `for 45 mins`, `for 2h`, `for 2h15m`). The duration is only applied when the task also has a due date **with a time** (e.g. `do something tomorrow at 5pm for 30 minutes`). English only.
